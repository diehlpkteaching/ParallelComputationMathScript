...
\part{Introduction to the C++ standard library}
...
\subsection{A simple C++ program}


\lstinputlisting[language=C++,caption={A simple C++ program, the so-called ``Hello World'' example, which most languages start with.}]{ParallelComputationMathExamples/chapter2/lecture1-1.cpp}
