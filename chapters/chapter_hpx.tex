...
\begin{lstlisting}[language=c++,caption={Use a ready future to initialize the computational data.\label{code:hpx:future:then}},float,floatplacement=htb,escapechar=|]
