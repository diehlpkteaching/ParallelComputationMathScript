...
\include{sections/chapter_linear_algebra}
...
\include{sections/chapter_numerical_examples}

%----------------------------------------------------------------------------------------
\part{Parallel and distributed computing}
%----------------------------------------------------------------------------------------

\include{sections/chapter_parallel_distributed}
...
\include{sections/chapter_lists}
