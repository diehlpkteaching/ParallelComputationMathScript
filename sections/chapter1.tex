...
%----------------------------------------------------------------------------------------
\index{statements!iteration} For some applications, we have to repeat some operations multiple times. The C++ language provides two iteration statements: the \lstinline[language=C++]|for| loop and the \lstinline[language=C++]|while| loop. Let us look how to compute the sum of the numbers from one up to $n$
\begin{align}
...
\begin{exercise}
Define in your own words in which cases you should use a \lstinline[language=C++]|for| loop statement and a \lstinline[language=C++]|while| loop statement. 
\end{exercise}
